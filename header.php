						...
						<div class="navbar-header">
							...
							<div id="logo">
								<?php if ( '' !== get_header_image() ) { ?>
										<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img class="navbar-banner" src="<?php header_image(); ?>" alt="<?php echo get_bloginfo( 'name' ); ?>"  height="<?php echo esc_attr( get_custom_header()->height ); ?>" width="<?php echo esc_attr( get_custom_header()->width ); ?>" alt="<?php bloginfo( 'name' ); ?>"/></a>
											<?php if ( is_home() ) { ?>
